...
2. **Manual setup**: Add the configuration above to your global Claude rules at `~/.claude/CLAUDE.md`. You can also check out the [full gist](https://gist.github.com/abhieq31/c297c84e1684c330b3325825d835da03) for additional implementation details.
